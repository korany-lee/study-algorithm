...
const test = (i) => {
	if (i === 1) {
		const rockPaperScissors = require('../01_rockPaperScissors/gray');
	...
	if (i === 3) {
		const gray = require('../03_isSubsetOf/gray');
	...
	if (i === 4) {
		const nthFibonacci = require('../04_nthFibonacci/gray');
	...
	if (i === 5) {
		const bubbleSort = require('../05_bubbleSort/gray');
	...
	if (i === 6) {
		const commonCharacters = require('../06_commonCharacters/gray');
