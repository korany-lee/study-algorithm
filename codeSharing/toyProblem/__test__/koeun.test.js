...
const test = (i) => {
	...
	if (i === 2) {
		const func = require('../02_nonrepeatCharacter/koeun');
	...
	if (i === 3) {
		const func = require('../03_isSubsetOf/koeun');
	...
	if (i === 4) {
		const func = require('../04_nthFibonacci/koeun');
	...
	if (i === 5) {
		const func = require('../05_bubbleSort/koeun');
	...
	if (i === 6) {
		const func = require('../06_commonCharacters/koeun');
	...
	if (i === 7) {
		const Tree = require('../07_treeDFSelect/koeun');
	...
	if (i === 8) {
		const func = require('../08_largestProductOfThree/koeun');
	...
	if (i === 9) {
		const func = require('../09_deepEquality/koeun');
	...
	if (i === 10) {
		const func = require('../10_rotatedArraySearch/koeun');
	...
	if (i === 11) {
		const func = require('../11_powerSet/koeun');
